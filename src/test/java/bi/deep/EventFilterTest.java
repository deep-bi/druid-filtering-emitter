...
public class EventFilterTest {
    ...
    public void testAllowListWithDifferentKey() {
        ...
        EventFilter filter = builder().withAllowed("abc", "def").withKey("_metric_").build();
    ...
    public void testExcludedList() {
        ...
        Assert.assertTrue(filter.test(e3)); // because 'e3' not on exclude list and allow list is empty (everything passes)
    }

    @Test
    public void testAllowedExcludedList() {
        Assert.assertThrows(RuntimeException.class, () -> builder()
                .withAllowed("e1")
                .withExcluded("e2")
                .build());
    }
